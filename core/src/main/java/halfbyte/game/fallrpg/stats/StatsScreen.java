package halfbyte.game.fallrpg.stats;
...
public class StatsScreen extends AbstractScreen {
    ...
    // methods
    public StatsScreen(IGameServices game_services) {
        super(game_services);
        ...
        // title label
        Label label = new Label("Stats", GameAssetManager.getInstance().getLabelStyle(GameAssetManager.ETextSize.LARGEST));
