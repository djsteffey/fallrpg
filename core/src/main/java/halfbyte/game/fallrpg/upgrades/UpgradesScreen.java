package halfbyte.game.fallrpg.upgrades;
...
public class UpgradesScreen extends AbstractScreen {
    ...
    // methods
    public UpgradesScreen(IGameServices game_services) {
        super(game_services);
        ...
        // title label
        Label label = new Label("Upgrades", GameAssetManager.getInstance().getLabelStyle(GameAssetManager.ETextSize.LARGEST));
        ...
        button.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                UpgradesScreen.this.onButtonBack();
            }
        });
